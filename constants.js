...
不在场角色：出现过的但当前不在场的女性角色，用于区分在场/不在场，避免信息混淆（如：优菈-在野外巡逻；没有则写「无」或「所有角色都在场」）
处女膜状态：女性角色的处女膜状态（如：琴：完好、芭芭拉：已破）
做爱次数：女性角色的累计性行为总次数，终身累计、永不归零（如：琴：0次、芭芭拉：3次）
当前好感度：所有已追踪女性角色（在场+不在场）对主角的好感度（-100~+100，如：琴：75（喜欢）、芭芭拉：-30（冷淡）、优菈：10（中立））
身体外貌：女性角色的当前外貌，必须包含「服装/姿势」两项，格式「服装/姿势」，无衣物时服装写「裸体」（如：琴：骑士制服破损/站立、芭芭拉：裸体/躺在床上）
