...
重要记忆点：改变人生的重要事件，每角色最多6条合计≤70字（如：- 琴：帮助旅行者解决风魔龙危机|欠旅行者一个人情）
...
- 重要记忆点：仅当发生值得记录的新事件才追加；每角色最多6条，出现第7条时替换最不重要的一条；每角色6条合计≤70字
...
⚠️ 状态追踪条目中「重要记忆点」是最后一个字段，输出完毕后该条目立即结束，严禁在重要记忆点之后附加任何其他内容（包括叙事要点）。
...
4. 叙事要点必须作为 summary_entries 数组中独立的条目输出，严禁与状态追踪条目合并或附加在状态追踪条目之后
