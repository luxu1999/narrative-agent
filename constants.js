...
- 身体外貌：必须包含「服装/姿势」两个信息。服装：全裸写「全裸」；只穿内衣写「只穿[颜色][款式]内衣内裤」；穿戴整齐写「外衣,内衣,内裤,袜子,鞋子」每项必须有颜色+款式。姿势：写具体位置（站/坐/躺/跪在哪里或和谁），如「站在窗边」「坐在床上」「躺在沙发上」「被xx抱在怀里」，禁止笼统写「站立」「坐着」。仅当明确换装/脱衣/姿势变化才更新，严禁凭空改服装或姿势。⚠️若上一状态为旧格式（服装简略未含内衣内裤袜子鞋子、或姿势笼统如「站立」「躺着」），本轮即使服装姿势无变化也必须按新格式升级——保留已有信息，根据角色设定合理补全缺失项；严禁直接照抄旧格式
